/* ═══════════════════════════════════════════════════════════════════════
   ...
   The site is seventeen static pages plus about 230KB of shared engine, so
   there is no reason to be clever: precache the lot on install and serve
   everything from the cache afterwards. Total is a little over 2MB, which is
   nothing on a phone and means a page opened in a tunnel behaves exactly as
   it does at a desk.
   ...
   register nothing.
   ═══════════════════════════════════════════════════════════════════════ */
const CACHE = "options-visually-v2";
